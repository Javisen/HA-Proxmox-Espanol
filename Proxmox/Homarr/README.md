...
## 📸 Vista General
<p align="center"> <img src="./homarr.png" alt="Dashboard de Homarr" style="width:55%; max-width:600px; margin-right:10px;"> <img src="./movil.png" alt="Dashboard móvil de Homarr" style="width:35%; max-width:150px;"> </p>
